...
public class NextCloud extends Domain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        asvStudents.add(new Student("ihk", null, null));
        ...
        asvStudents.add(new Student("r.braun", null, null));
        asvStudents.add(new Student("j.bass", null, null));
        asvStudents.add(new Student("m.haertl", null, null));
        asvStudents.add(new Student("c.schnell", null, null));
        asvStudents.add(new Student("k.schnell", null, null));
        asvStudents.add(new Student("p.pflege", null, null));
        asvStudents.add(new Student("b.bio", null, null));
        asvStudents.add(new Student("m.mathe", null, null));
        asvStudents.add(new Student("m.musik", null, null));
        asvStudents.add(new Student("k.kunst", null, null));
        asvStudents.add(new Student("g.lehrer", null, null));
        asvStudents.add(new Student("m.mustermann", null, null));
        Diff diff = new Diff();
