...
let VuCard = class VuCard extends LitElement {
    constructor() {
        super(...arguments);
        this.loading = false;
        this.error = "";
...
__decorate([
    property()
], VuCard.prototype, "loading", void 0);
__decorate([
    property()
], VuCard.prototype, "error", void 0);
__decorate([
    property()
], VuCard.prototype, "_color", void 0);
VuCard = __decorate([
    customElement('vu-card')
], VuCard);
export { VuCard };
//# sourceMappingURL=vu-card.js.map