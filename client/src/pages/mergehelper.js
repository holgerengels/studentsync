...
export const renderDiff = (diff) => html `
    <div class="line">
...
const _renderAttribute = (change, attribute) => html `${change[attribute + "E"] ? html `<span class="ee">${change[attribute + "E"]}</span>` : ''}${change[attribute]}`;
