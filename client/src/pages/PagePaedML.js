...
let PagePaedML = class PagePaedML extends connect(store, LitElement) {
    constructor() {
        super();
        this._loading = false;
    ...
    mapState(state) {
        return {
            _loading: state.paedml.loading,
            _students: state.paedml.filter !== "" ? state.paedml.filtered : state.paedml.entities,
            _error: state.paedml.error,
        };
    }
    static get styles() {
        // language=CSS
    ...
    render() {
      ...
      <mwc-top-app-bar id="bar" dense>
        ...
        <div slot="title" ?hidden="${this._showFilter}">PaedML</div>
    ...
    _filter(filter) {
        store.dispatch.paedml.filter(filter);
    }
...
__decorate([
    property()
], PagePaedML.prototype, "_loading", void 0);
__decorate([
    property()
], PagePaedML.prototype, "_showFilter", void 0);
__decorate([
    property()
], PagePaedML.prototype, "_students", void 0);
__decorate([
    property()
], PagePaedML.prototype, "_error", void 0);
PagePaedML = __decorate([
    customElement('page-paedml')
], PagePaedML);
export { PagePaedML };
//# sourceMappingURL=PagePaedML.js.map