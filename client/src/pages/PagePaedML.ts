  ...
  render() {
    ...
    return html`
      <mwc-top-app-bar id="bar" dense>
        ...
        <a id="download"  slot="actions" href="${endpoint.list('paedml') + '&file=csv&referer=' + location.origin}" download="students.csv" referrerpolicy="origin" hidden></a>
        <mwc-icon-button icon="save_alt" slot="actionItems" title="PaedML Download" @click="${() => this._download.click()}"></mwc-icon-button>
