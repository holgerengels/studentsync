...
let PageUntis = class PageUntis extends connect(store, LitElement) {
    constructor() {
        super();
        this._loading = false;
...
__decorate([
    property()
], PageUntis.prototype, "_loading", void 0);
__decorate([
    property()
], PageUntis.prototype, "_showFilter", void 0);
__decorate([
    property()
], PageUntis.prototype, "_students", void 0);
__decorate([
    property()
], PageUntis.prototype, "_error", void 0);
PageUntis = __decorate([
    customElement('page-untis')
], PageUntis);
export { PageUntis };
//# sourceMappingURL=PageUntis.js.map