...
let VuSync = class VuSync extends connect(store, LitElement) {
    constructor() {
        super(...arguments);
        this._page = 'main';
...
__decorate([
    property()
], VuSync.prototype, "_page", void 0);
__decorate([
    property()
], VuSync.prototype, "_drawerOpen", void 0);
VuSync = __decorate([
    customElement('vu-sync')
], VuSync);
export { VuSync };
//# sourceMappingURL=vu-sync.js.map